          ...
          {portfolioView === "cover" && (
            ...
            >
              ...
              {!showDetails && (
                <>
                  ...
                  <div 
                    ...
                    className="absolute left-[3%] top-[6%] sm:left-[4%] sm:top-[10%] lg:left-[5%] lg:top-[12%] z-[5] w-[75px] sm:w-[110px] md:w-[135px] lg:w-[160px] opacity-0 hover:opacity-100 cursor-pointer"
                  >
                    <img 
                      src="/digi_design_01.png" 
                      alt="Digi Design 01" 
                  ...
                  <div 
                    ...
                    className="absolute right-[3%] top-[6%] sm:right-[4%] sm:top-[10%] lg:right-[5%] lg:top-[12%] z-[5] w-[75px] sm:w-[110px] md:w-[135px] lg:w-[160px] opacity-0 hover:opacity-100 cursor-pointer"
                  >
                    <img 
                      src="/font_concept.png" 
                      alt="Font Concept Sheet" 
                  ...
                  <div 
                    ...
                    className="absolute left-[3%] bottom-[6%] sm:left-[4%] sm:bottom-[10%] lg:left-[5%] lg:bottom-[12%] z-[5] w-[75px] sm:w-[110px] md:w-[135px] lg:w-[160px] opacity-0 hover:opacity-100 cursor-pointer"
                  >
                    <img 
                      src="/template_shape.png" 
                      alt="Shape Template" 
                  ...
                  <div 
                    ...
                    className="absolute right-[3%] bottom-[6%] sm:right-[4%] sm:bottom-[10%] lg:right-[5%] lg:bottom-[12%] z-[5] w-[75px] sm:w-[110px] md:w-[135px] lg:w-[160px] opacity-0 hover:opacity-100 cursor-pointer"
                  >
                    <img 
                      src="/bookplate.png" 
                      alt="Ex Libris Bookplate Design Art" 
                  ...
                  <div 
                    ...
                    className="absolute left-[3%] top-[48%] -translate-y-1/2 sm:left-[4%] lg:left-[5%] z-[5] w-[75px] sm:w-[110px] md:w-[135px] lg:w-[160px] opacity-0 hover:opacity-100 cursor-pointer"
                  >
                    <img 
                      src="/memories.png" 
                      alt="Memories concept" 
              ...
              >
                ...
                >
                  <img 
                    src={customPortrait || "/src/assets/images/kimeunbin_portrait_1781527351351.jpg"} 
